...
> **Note**
> By interacting with [@svengreb][35] projects, organizations, and their communities you agree to abide to its [code of conduct][1] and follow [general open source contribution guidelines][6] and [etiquettes][31]!

We’re excited that you’re interested in contributing to the project!
...
Some open source projects are larger and might consist of many repositories and are designed to be very modular.
**Please make sure to determine the correct repository before you continue!**
Contributions are welcome in their respective repositories. This helps project members, volunteers and contributors to process every contribution faster without organization overhead.
...
- **[Attach files][10] like screenshots or videos** if appropriate which show you following the described steps and clearly demonstrate the problem.
- **Provide specific examples to demonstrate the steps**. Include links to files or GitHub projects, or copy/paste snippets. If you are providing snippets in the issue, use [Markdown code blocks][11] or [attach files to the issue][10].

**Do NOT [report security vulnerabilities][13] in public issues!**
Please only [contact one of the project members in a responsible manner][2] to help project members to process and resolve it, [working towards a coordinated disclosure][12]. We will assess the issue as soon as possible on a best-effort basis and will give you an estimate for when we have a fix and release available for [an public disclosure][14].
...
- **Provide examples to demonstrate the need of an enhancement**. Include links to files or GitHub projects, or copy/paste snippets. If you are providing snippets in the issue, use [Markdown code blocks][11] or [attach files to the issue][10].
- **Describe the current behavior** and **explain which behavior you expected to see instead** and why.
- **Explain why this enhancement would be useful** to most users.
- **Optionally list other projects where this enhancement exists** or, if appropriate, **[attach files][10] like screenshots, videos or animated GIFs** showing the suggested enhancement.
...
- **Do not include issue numbers in the pull request title** but add it to the top of the description like shown in the pull request template. This will enable the use of [GitHub‘s issue keyword][15] feature to link to specific [enhancement suggestions](#enhancement-suggestions) or [bug reports](#bug-reports).
- **[Attach files][10] like screenshots, videos or animated GIFs**, if appropriate, that clearly demonstrate the change.
...
- **Make sure to create the pull request from a [topic branch][16]**.
...
The documentation consists of user guides, specifications that serve as core references and dedicated documentations for each project.
...
The project uses the [GitHub Flow][22] branching model. The repository consists of the `main` core branch with an infinite development lifecycle. The source code of [Git‘s `HEAD`][17] in this branch contains the latest development state and reflects all tagged release versions.
...
Larger and major open source projects have their own style guides, a set of standards and conventions for the writing and design of code, documentations and [Git][18] [][^1] [commit messages][19]. It is much easier to understand content and a large code base when it is written with a consistent style.
...
Therefore the project adheres to several style guides to ensure good quality and ensure to keep these standards for the future of the project. The listed style guides are used in all projects:

- [Markdown Style Guide][20]
- [JavaScript Style Guide][8]
- [Git Style Guide][21] — A well-crafted Git commit message is the best way to communicate _context_ about a change to the maintainers. The code will tell what changed, but only the commit message can properly tell why. Re-establishing the context of a piece of code is wasteful. We can‘t avoid it completely, so our efforts should go to reducing it as much as possible. The style guide assumes that you are familiar with the [GitHub Flow][22] branching model.
...
The project follows the [Semantic Versioning Specification][26] (SemVer).
...
Every significant change is at least documented in the [changelog][27] of the respective project, but will also be announced through the project‘s infrastructure and community platforms.
...
A MCVE is a common practice for large development communities and platforms like [Stack Overflow][23] and sometimes it is also called [SSCCE][24], a **S**hort, **S**elf **C**ontained, **C**orrect (Compilable), **E**xample.

The recommended way for GitHub based projects is to create a MCVE as [Codespaces][32], [Gist][25], or new repository, but you can also [attach it to issues and pull requests as file(s)][10], use any free code (snippet) or file hosting service like [Codesandbox][33] or paste the code in [Markdown code blocks][11] into the issue.
...
Thanks for the inspirations to GitHub‘s [Open Source Guides][5] and various contribution guides of large open source projects like [React][28], [Atom][30], [PhotoPrism][34] and [Ruby on Rails][29].
...
[1]: https://github.com/svengreb/.github/blob/main/code_of_conduct.md

<!--lint enable no-duplicate-definitions-->

[2]: https://github.com/svengreb/.github/blob/main/support.md
...
[8]: https://github.com/svengreb/styleguide-javascript
[9]: https://docs.github.com/en/search-github/searching-on-github/searching-issues-and-pull-requests
[10]: https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/attaching-files
[11]: https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax
[12]: https://docs.github.com/en/code-security/repository-security-advisories/about-coordinated-disclosure-of-security-vulnerabilities
[13]: https://docs.github.com/en/code-security/repository-security-advisories/about-coordinated-disclosure-of-security-vulnerabilities#best-practices-for-vulnerability-reporters
[14]: https://docs.github.com/en/code-security/repository-security-advisories/about-coordinated-disclosure-of-security-vulnerabilities#best-practices-for-maintainers
[15]: https://docs.github.com/en/github/managing-your-work-on-github/linking-a-pull-request-to-an-issue
[16]: https://git-scm.com/book/en/v2/Git-Branching-Branching-Workflows#_topic_branch
[17]: https://git-scm.com/book/en/v2/Git-Internals-Git-References#ref_the_ref
[18]: https://git-scm.com
[19]: https://git-scm.com/docs/git-commit
[20]: https://github.com/svengreb/styleguide-markdown
[21]: https://github.com/svengreb/styleguide-git
[22]: https://docs.github.com/en/get-started/quickstart/github-flow
[23]: https://stackoverflow.com/help/mcve
[24]: http://sscce.org
[25]: https://gist.github.com
[26]: https://semver.org
[27]: https://keepachangelog.com
[28]: https://reactjs.org/docs/how-to-contribute.html
[29]: https://guides.rubyonrails.org/contributing_to_ruby_on_rails.html
[30]: https://github.com/atom/atom/blob/master/CONTRIBUTING.md
[31]: https://opensource.how/etiquette
[32]: https://github.com/features/codespaces
[33]: https://codesandbox.io
[34]: https://docs.photoprism.app/developer-guide
[35]: https://github.com/svengreb
