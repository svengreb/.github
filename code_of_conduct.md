...
All members, volunteers and contributors in this project are required to act according to this Code of Conduct. We ask you to follow these guidelines which help steer our interactions and strive to keep it a positive and growing project and help us provide and ensure a safe environment for everyone. Let‘s work together to keep the project community a place where people feel safe to participate by being respectful of them and their time.
...
- **[email][1]** (recommended) — Send your report as email to [support@svengreb.de][1]. Note that the email protocol does not provide end-to-end encryption and therefore, if possible and appropriate, please encrypt your email with Sven Greb‘s [Age][16] [][^1] or [PGP][17] [][^2] ([GPG][18]) key where both can be found [in the @svengreb GitHub `.github` repository][19] [][^3] [][^4] or inlined as plain-text in the [“Reporting Security Issues“ section in the @svengreb GitHub account‘s default `security.md` file][20].
- **[Matrix][9]** (recommended) [^5] — Send a private (direct) message to [`@svengreb:matrix.org`][10] or join the official Matrix space of the specific project to let a verified community moderator or manager forward your report. All private communications are end-to-end encrypted and therefore no data can be intercepted by the platform host.
- **[Discord][11]** (inadvisable) [^5] — Send a private (direct) message to [`svengreb#2186`][12] or join the official server of the specific project to let a verified community moderator or manager forward your report. Note that Discord is a a commercially driven platform and there is no end-to-end encryption in place and therefore communication data could be intercepted.
- **[Mastodon][13]** (not optimal) [^5] — send [a private (direct) message][14] to [`@svengreb@fosstodon.org`][15] or the official account of the specific project. Note that communications are not end-to-end encrypted so please make sure to transfer possibly sensitive data via securely encrypted methods.
...
<p align="center">
  <a href="https://github.com/svengreb/.github/blob/main/license" target="_blank">
...
[^3]: https://github.com/svengreb/.github/blob/main/data/svengreb.age.txt.pub
[^4]: https://github.com/svengreb/.github/blob/main/data/svengreb.gpg.asc
[^5]: https://github.com/svengreb/.github/blob/main/support.md#updates-communities--content
...
[12]: https://discordapp.com/users/448543165021159424
[13]: https://joinmastodon.org
[14]: https://docs.joinmastodon.org/user/network/#direct
[15]: https://fosstodon.org/@svengreb
[16]: https://raw.githubusercontent.com/svengreb/.github/main/data/svengreb.age.txt.pub
[17]: https://raw.githubusercontent.com/svengreb/.github/main/data/svengreb.gpg.asc
[18]: https://gnupg.org
[19]: https://github.com/svengreb/.github/tree/main/data
[20]: https://github.com/svengreb/.github/blob/main/security.md#reporting-security-issues
